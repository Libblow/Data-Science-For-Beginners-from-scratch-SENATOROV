...
#     Соглашения о кодировании для кода Python, входящего в стандартную библиотеку основного дистрибутива Python
...
# приватные атрибуты классов, "змеиный регистр"
...
# file > Preferences > settings > wrap > wordWrapColumn and 79
# 3. Сколько символов по pep8 разрешено на строке?
# 79
# 4. Какие способы переноса строк показаны в видео:
# 1.комментарии с помощью #
# 2. длинный код оборачиваем а () и внутри этих скобок можем делать перенос строки
# 3. "склеивание" разбиваем длинную строку с присвоением к каждой части своего имени, далее сумируем две переменные.
#
...
# при вызове терминала первая вкладка problems
# 6. Где в vscode находится клиент гита? как в нём отправить коммит? как принять домашку?
# на левой панеле соединённые три кружка
# 7. Что такое GIT? он локальный? В нём можно посмотреть историю изменений файлов и вернуться к любому коммиту?
# Система контроля версий. Гит может быть локальным, централизованным и распределённым. Да , можно посмотреть историю и вернуться к любому коммиту.
# 8. Как вставить картинку в маркдаун?
# ![alt text](image.png)  # ctrl+v в ячейку маркдаун
# 9. Где посмотреть длину строки в vs code?
# в правом нижнем углу vsc
# 10. Как поменять тип ячейки с питона на маркдаун?
# в ячейке в правом нижнем углу
# 11. Как запустить сразу все ячейки в юпитере?
# run all/выполнить всё
# 12. Как изменить размер картинки в юпитере? Нужно для этого знать HTML?
# <img href="@" size="@">, нужно знать базовые теги html.
# 13. Какой хоткей чтобы запустить ячейку с смещением на следующую?
# Shift+enter.
# 14. Как включить отображение номеров строк в юпитере(Cell line numbers)?
# ... > show cell line numbers.
# 15. Что такое "Go To" чем это полезно? Как перейти сразу на ошибочную ячейку?
# После запуска ячейки, если возникает ошибка, появляется крестик(go to), позволяет сразу посмотреть где "отвалилась" ячейка
# 16. Как очистить вывод ячеек которые уже запущены?
# Clear all outputs
#
# 17. Как работать одновременно в нескольких файлах в VSCODE? Что такое SPLIT?
# нажимаем на кнопку разделённого по полам экрана в правом верхнем углу. Разделяет экран дляработы с текстом и кодом одновременно и тд.
#
...
# name Dict is not defined(ошибка в видео, не понимает что такое dict)
...
# проверка на то что весь код "идеально написан"
# 23. Что такое трассировка ошибки?
# NameError, "визуалка ошибки" (визуализация ошибки)
# 24. Что значит отвалился интерпритатор?
# произошка ошибка в коде
#
